...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // the onPlay(), onPause(), and onSkipToPrevious() callbacks.
        // Pass an instance of this class into the MediaSession.setCallback() method in the method you created in TO-DO 1.
