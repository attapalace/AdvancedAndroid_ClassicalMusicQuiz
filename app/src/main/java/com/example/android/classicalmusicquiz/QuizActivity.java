...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    //completed (2): Call MediaButtonReceiver.handleIntent and pass in the incoming intent as well
    // as the MediaSession object to forward the intent to the MediaSession.Callbacks.
}
